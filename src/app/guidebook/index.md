...
_Everything Ghost.md does, and how it is made, in 44 short chapters. Chapters 1 to 26 need no technical background; chapters 27 to 44 are for someone who can read code, starting at [[Ghost.md in one page]]._
...
41. [[Over the air, and releases]] — how a release could lock phones out, and why it does not
...
- **Every release carries its own test results.** A deploy runs all three suites first and refuses to ship a failure, and the report is built into the app: at 1.8.0-12, 3,046 of 3,169 tests passed, 123 were skipped and none failed, under Settings › Test results in Developer mode ([[Tests, and the report that ships]]).
