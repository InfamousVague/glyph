 ...
 */
const KEYS = ['glyph-preferences', 'glyph-guide-seen', 'glyph-refine-queue', 'glyph-last-capture', 'glyph-haptics', 'glyph-notes', 'glyph-side-key', 'glyph-format-queue', 'glyph-ai-results', 'glyph-ai-log', 'glyph-ai-marks', 'glyph-all-notes-sort', 'glyph-projects', 'glyph-workspaces', 'glyph-guide-started', 'glyph-guide-page', 'glyph-sample-note'];
