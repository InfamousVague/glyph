 ...
 * ones the selection touches, where marks are shown as written so they can be edited. Five decorators walked the
 * visible lines with the same loop, and two gathered the selection's lines with the same one.
 */
