...
interface NoteSettingsProps {
  ...
  onFind?: () => void;
  /** Lays the note's to-dos out as a board (core/boards.ts); absent where there is nothing to make one of. */
  onMakeBoard?: () => void;
        ...
        {onFind || onMakeBoard || (view && onView) ? (
          <>
            ...
            <div className={styles.group}>
              ...
              {/* A list of to-dos laid out as columns, in the note's own words (docs/BOARDS.md). */}
              {onMakeBoard ? (
                <button type="button" className={styles.row} onClick={onMakeBoard}>
                  ...
                  <span className={styles.label}>
                    Make a board
                    <span className={styles.hint}>Every to-do in this note becomes a card.</span>
                  </span>
                </button>
              ) : null}
            </div>
