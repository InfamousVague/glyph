...
export const LESSONS: Lesson[] = [
  ...
  // ---- More Markdown: marks most Markdown apps read, which a note draws too ---------------------------------------
  {
    ...
    rows: ['A table'],
    title: 'A table',
    teach: 'Pipes between the cells, and a row of dashes under the first row. In a note the table is drawn as a table, and a tap on it changes it without the pipes.',
    example: '| What | Packed |\n| --- | --- |\n| Tent | Yes |',
  ...
  // ---- Lines that do more: plain characters a note does something with -------------------------------------------
  {
    ...
    rows: ['A tag'],
    title: 'A tag',
    teach: 'A hash against a word, with no space between, tags the line: #web. A slash puts one tag inside another, as in #work/clients. A hash and a space at the start of a line is a heading instead.',
