 ...
 * holds it. What is made and changed on a canvas is edits.ts, where things are geometry.ts, how lines run lines.ts,
 * and what a card looks like cards.ts; none of them knows the screen.
 *
